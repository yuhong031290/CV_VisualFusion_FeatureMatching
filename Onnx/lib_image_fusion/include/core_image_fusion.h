...
public:
  ...
  struct Param {
    ...
    Param &set_shadow(bool v) { do_shadow = v; return *this; }
    ...
    Param &set_threshold_equalization(int v) { threshold_equalization = v; return *this; }
    Param &set_threshold_equalization_low(int v) { threshold_equalization_low = v; return *this; }
    Param &set_threshold_equalization_high(int v) { threshold_equalization_high = v; return *this; }
    Param &set_threshold_equalization_zero(int v) { threshold_equalization_zero = v; return *this; }
  };
