def interpolate(input: Tensor,
  ...
  if _24:
    ...
    if torch.__is__(align_corners, None):
      torch.warn(torch.format(_1, mode))
  ...
  if _26:
    ...
    if torch.__isnot__(size0, None):
      ...
      scale_factors0, size3, output_size0 = None, size5, output_size1
    else:
      ...
      if _29:
        ...
        scale_factors1, size6, output_size2 = scale_factors2, size7, None
      else:
        ops.prim.RaiseException(_3)
        scale_factors1, size6, output_size2 = _18, _21, _17
      scale_factors0, size3, output_size0 = scale_factors1, size6, output_size2
  ...
  if _32:
    ...
    if _33:
      ...
      while _36:
        ...
        _36, _35 = _40, _39
      scale_factors4 : Optional[List[float]] = scale_factors5
    else:
  ...
  if torch.eq(mode, "area"):
    ...
    _42 = False
  if _42:
    recompute_scale_factor2 : Optional[bool] = True
  else:
