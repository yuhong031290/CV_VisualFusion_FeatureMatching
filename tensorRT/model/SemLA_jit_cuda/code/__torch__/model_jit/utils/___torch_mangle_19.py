class DWConv(Module):
  ...
  group_conv3x3 : __torch__.torch.nn.modules.conv.___torch_mangle_17.Conv2d
  norm : __torch__.torch.nn.modules.batchnorm.___torch_mangle_15.BatchNorm2d
  act : __torch__.torch.nn.modules.activation.ReLU
  projection : __torch__.torch.nn.modules.conv.___torch_mangle_18.Conv2d
  def forward(self: __torch__.model_jit.utils.___torch_mangle_19.DWConv,
    x: Tensor) -> Tensor:
