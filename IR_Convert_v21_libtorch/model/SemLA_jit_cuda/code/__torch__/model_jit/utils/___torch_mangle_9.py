class DWConv(Module):
  ...
  group_conv3x3 : __torch__.torch.nn.modules.conv.___torch_mangle_7.Conv2d
  norm : __torch__.torch.nn.modules.batchnorm.___torch_mangle_5.BatchNorm2d
  act : __torch__.torch.nn.modules.activation.ReLU
  projection : __torch__.torch.nn.modules.conv.___torch_mangle_8.Conv2d
  def forward(self: __torch__.model_jit.utils.___torch_mangle_9.DWConv,
    x: Tensor) -> Tensor:
